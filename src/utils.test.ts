...
import { uint8ArrayToHex, hexToUint8Array, base58Encode, base58Decode } from './utils';
...
describe('utils.ts', () => {
  ...
  describe('hexToUint8Array', () => {
    ...
    it('should throw an error for non-string input', () => {
      ...
      expect(() => hexToUint8Array(123)).toThrow('Expected string containing hex data');
    });
  });
  ...
  describe('base58Encode', () => {
    ...
    it('should encode typical bitcoin-style address', () => {
      ...
      const data = hexToUint8Array('00010966776006953D5567439E5E39F86A0D273BEED');
      const result = base58Encode(data);
