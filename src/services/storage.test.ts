...
describe("StorageService", () => {
  ...
  describe("error handling", () => {
    ...
    it("should handle put request error", async () => {
      ...
      // Execute and verify
      await expect(storage.storeItem("keys", item)).rejects.toThrow(
        ApplicationError
      );
    });
    ...
    it("should handle get request error", async () => {
      ...
      // Execute and verify
      await expect(storage.getItem("keys", "test-id")).rejects.toThrow(
        ApplicationError
      );
    });
    ...
    it("should handle delete request error", async () => {
      ...
      // Execute and verify
      await expect(storage.deleteItem("keys", "test-id")).rejects.toThrow(
        ApplicationError
      );
    });
